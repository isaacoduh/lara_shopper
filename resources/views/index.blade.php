            ...
            <div class="row pt120">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="heading align-center mb60">
                        <h4 class="h1 heading-title">Lara Shopper,</h4>
                        <p class="heading-text">You bring the funds, we provide the product and God does the rest.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="books-item">
                                <div class="books-item-thumb">
                                    <img src="/app/img/book1.png" alt="book">
